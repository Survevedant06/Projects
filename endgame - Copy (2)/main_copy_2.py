...
def gemini_response(query):
    try:
        prompt = f"Answer in 5-10 words: {query}"  # Still instructing Gemini
        response = model.generate_content(prompt)  

        # Manually truncate response to 10 words max
        short_response = " ".join(response.text.split()[:10])  
...
class FaceAuthenticationWindow(QtWidgets.QMainWindow):
    ...
    def launch_jarvis(self):
        ...
        subprocess.Popen(["python", "main_copy_2.py"])
