...
import { X, Plus, Clock, DollarSign, MapPin } from 'lucide-react'

export default function AddActivityModal({ dayPlanId, dayNumber, isOpen, onClose, onAdd, currency = 'USD', destination = '' }) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-150">
      <div className="relative w-full max-w-lg rounded-2xl bg-card border shadow-2xl p-6 overflow-hidden">
        <div className="flex items-center justify-between border-b pb-3 mb-4">
          <h3 className="text-lg font-bold text-foreground">Add Activity to Day {dayNumber}</h3>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              type="text"
              required
              placeholder="e.g. Louvre Museum, Tokyo Tower"
              value={formData.name}
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2 rounded-lg border bg-background text-sm focus:ring-2 focus:ring-blue-500 outline-none"
                placeholder="Sightseeing, Food, Nature"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <input
              type="text"
              placeholder={`${destination} or specific address`}
          ...
          <div>
            ...
            <textarea
              rows={2}
              placeholder="What to see and do here..."
